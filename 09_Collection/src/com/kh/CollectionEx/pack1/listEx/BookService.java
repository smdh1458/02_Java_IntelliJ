...
public class BookService {
    ...
    */
    public void mathod1(){
        ...
        list1.add("아무거나 넣을 수 있어요"); // 알아서 자동으로 index = 1번째 자리에 문자열이 들어감
        list1.add(123);
        ...
        System.out.println("list에 저장된 값의 개수: "+list1.size());

    }

    /*
    * List에서 원하는 자료형만 넣을 수 있도록 자료형 제한 설정하기
    */
    ...
    public void mathod2(){
        ...
        ArrayList<원하는 자료형> list1 = new ArrayList<원하는 자료형>();    *주로 사용
   ...
   //1. 책 추가하기 기능 만들자!
    ...
    //2.책 제거하기 기능 설정하자! 제거하고자하는 책 제목을 입력하고 책제목이 일치하는 책을 제거하자
    public void removeBook(String title){
        ...
        for(int i =0; i<bookList.size(); i++){
            /*
            책목록에서       가져온index번호에     적혀있는 책제목에서      내가 찾고자하는것과 똑같은것이 존재한다면          첵제목
            bookList.           get(i).                 getTitle().                         equals                             (title)
             */
            if(bookList.get(i).getTitle().equals(title)){
                bookList.remove(i); //책제거
                System.out.println("책이 성공적으로 삭제되었습니다.: "+title);
                found = true;
                break; //삭제하고자 하는 책을 찾고 삭제했다면 더 이상 반복할 필요가 없음
            }
