...
public class Menu {
    ...
    // - 동일 : 가르키고 있는 것이 같음   Object.hashConde()
    ...
    public boolean equals(Object o) {
        //들어온 값이 Menu 타입인지 확인하고 메뉴 타입이 아니라면 같은것인지 확인하고 비교할 이유가 없기 때문에 돌려보내기
        ...
        // Double.compare(price, menu.price) == 0 주로 정수나 실수 비교할때 사용
        // 두 값이 같으면 0 첫번째 값이 더 작으면 음수 / 첫번째 값이 더 크면 양수

        // 2 = 2 ==0             2 = 4 == -2                2 = 1 == 1
    }


    //동일 비교 : Object.hashCode() 매서드 재정의(오버라이딩)
    //hash함수 : 값을 넣으면 같은 길이의 문자열이 반환되는 함수
    ...
    //hach : 컴퓨터 과학 주로 조각내다, 잘게 자르다 의미에서 사용
