...
public class ArrayEx3 {
    ...
    //int [][] grades={{90, 85, 88, 92},{78, 82, 79, 85},{88, 90, 92, 85}};
    //String[] 과일들 = {      "사과",        "오렌지",      "바나나"     }
    ...
    public void method3(){
        String [][] fruits = {
                //index 0번째 자리 그룹
                {"사과","빨강","단맛","중간"}, //과일 1(사과)의 정보가 들어있는 index
                {"귤","오렌지","새콤","작음"}, //과일 2(귤)의 정보가 들어있는 index
                {"포도","보라","달콤","작음"} //과일 3(포도)의 정보가 들어있는 index
        };
        //각 과일의 정보 출력
        ...
        *
        * 주의해야할 점
        * 없는 자리에 있는 값을 가져오라하면 문제 발생
        * index는 무조건 0부터 순차적으로 자동 번호 매김이 됨
        * 마음대로 바꾸기 X
        * 만약에 길이가 3인 배열에 index 0, 1번째 값 기입을 안했다면
        * index[0] = 0
        * index[1] = 0
        * index[2] = 개발자가 기입한 숫자
        * index로 치면 0,1,2
